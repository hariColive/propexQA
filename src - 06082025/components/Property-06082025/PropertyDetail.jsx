...
const PropertyDetail = () => {
      ...
      try {
        postAPICall(url, {}, (res) => {
          ...
          const found = res.Data.Property.find(
            (p) => p.LocationLink === "colive_ppm_57174"
          );
          if (found) {
            // 3. Use PropertyID to fetch details
  ...
  return (
    ...
    <div className='p-4'>
      <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-extrabold mb-8 text-center">{property.PropertyName}</h1>
      ...
      <MarketTrend locationLink="colive_ppm_57174" />
      <BookPropexHomes />
