          ...
          {!isSubmitted ? (
            <form onSubmit={handleSubmit(submitEnquireForm)} noValidate>
              ...
              <div className="relative mb-3 md:mb-4">
                ...
                <input className="w-full border-[1.5px] rounded-[5px] border-[#AAAAAA] text-black h-[40px] md:h-[45px] px-4 md:px-3 text-[15px] md:text-base mt-1 md:mt-1.5 font-normal pl-15" type='tel' maxLength={10} placeholder='Enter your Phone Number' name='mobileno' id='mobileno' onInput={(e) => e.target.value = e.target.value.replace(/[^0-9]/g, '')} 
                {...register("mobileno", 
