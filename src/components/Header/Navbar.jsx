    ...
    <>
      <nav className="bg-black fixed w-full top-0 z-10">
        <div className="head-container flex justify-between items-center py-1">
              ...
              {NavBarMenu.map((item) => {
                return (
                  <li key={item.id}>
                    <a
                      href={item.link}
                      className="inline-block text-white text-lg font-medium"
                    >
                      {item.title}
                    </a>
                  </li>
          ...
          <div className="navicons flex items-center justify-end gap-6">
            ...
            <div className="usericon">
              <a href="/">
                <img src={CallIcon} width={30} alt="Call" />
              </a>
            </div>
            <div className="whatsappIcon">
              <a href="/">
                <img src={whatsappIcon} width={30} alt="Whatsapp" />
              </a>
            </div>
      ...
      >
        <div className="p-4 bg-black flex justify-between">
          ...
          <div
            className="cursor-pointer text-[#EF1284] text-3xl font-extrabold flex justify-end"
            onClick={toggleMenu}
          >
            <IoClose />
          </div>
